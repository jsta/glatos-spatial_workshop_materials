...
> > 
> > ~~~
> > Warning in file(file, "rt"): cannot open file 'data/NEON-DS-Site-Layout-Files/
> > HARV/HARV_2NewPhenPlots.csv': No such file or directory
> > ~~~
> > {: .error}
> > 
> > 
...
> > 
> > ~~~
> > Error in str(newfish_tracks): object 'newfish_tracks' not found
> > ~~~
> > {: .error}
> >
> > 2)
...
> > 
> > ~~~
> > Error in st_as_sf(newfish_tracks, coords = c("decimalLon", "decimalLat"), : object 'newfish_tracks' not found
> > ~~~
> > {: .error}
> >
...
> > 
> > ~~~
> > Error in st_crs(newPlot.Sp.HARV): object 'newPlot.Sp.HARV' not found
> > ~~~
> > {: .error}
> >
...
> > 
> > ~~~
> > Error in fortify(data): object 'newPlot.Sp.HARV' not found
> > ~~~
> > {: .error}
> {: .solution}
{: .challenge}
