...
erie_zones <- st_read(
  "data/Lake_Erie_Walleye_Management_Units/Lake_Erie_Walleye_Management_Units.shp")
...
> >
> > ```{r}
> > newPlot.Sp.HARV <- st_as_sf(newfish_tracks, coords = c("decimalLon", "decimalLat"), crs = geogCRS)
> > ```
> >
...
> > ggplot() +
> >   geom_sf(data = fish_locations, color = "orange") +
