...
ggplot() +
  geom_raster(data = RGB_2m_df_nd, aes(x = x, y = y, fill = erie_bathy)) +
  scale_fill_identity() +
...
DSM_highvals <- reclassify(erie_bathy, rcl = c(0, 400, NA_integer_, 400, 420, 1L),
                           include.lowest = TRUE)
...
ggplot() +
  ...
  annotate(geom = 'raster', x = DSM_highvals$x, y = DSM_highvals$y, fill = scales::colour_ramp('deeppink')(DSM_highvals$erie_bathy)) +
